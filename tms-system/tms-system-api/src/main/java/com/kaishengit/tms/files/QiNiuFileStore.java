package com.kaishengit.tms.files;
...
public class QiNiuFileStore {
    ...
    public String saveFile(InputStream inputStream, String fileName) throws IOException {
        ...
        Auth auth = Auth.create("ihGMvJPxa1pueRhgomF3yNLni79nhI4YHxeGttmr","lLeD0G7dGQ6gg8bMxsuSZpWoRKctZkju4pt2DBjD");
        String upToken = auth.uploadToken("qiniu-cloud");
    ...
    public byte[] getFile(String fileName) throws IOException {
        ...
        String finalName = String.format("%s/%s","http://ozp3bw3wo.bkt.clouddn.com",fileName);
        //url转byte
